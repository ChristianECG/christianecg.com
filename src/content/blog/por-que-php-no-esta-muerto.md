...
¿Por qué PHP no está muerto? Porque PHP es un lenguaje muy potente que se puede utilizar para la creación de aplicaciones web. Y esta ha sido la razón por la que más aplicaciones han sido creadas con él. Facebook en sus inicios fue creado con PHP, y es la red social más grande del mundo.
